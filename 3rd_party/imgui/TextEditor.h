...
public:
	...
	void SetBreakpoints(const Breakpoints& aMarkers) { mBreakpointLines = aMarkers; }
	const Breakpoints& GetBreakpoints() { return mBreakpointLines; }
	void SetCurrentBreakPoint(int line) { mCurrentBreakpoint = line; }
